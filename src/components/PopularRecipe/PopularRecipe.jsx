...
const PopularRecipe = () => {
    return (
        <div>
            <h2 className='text-center text-4xl font-bold mb-7'>Our Most Popular Recipies 2023</h2>
            <div className='grid md:grid-cols-2 gap-5 my-5 mx-10 '>
            <div className='text-center'>
                <img className='h-96' src={'https://i.ibb.co/x3790n2/20211118-0222-Healthyish0187.webp'} alt="" />
            </div>
